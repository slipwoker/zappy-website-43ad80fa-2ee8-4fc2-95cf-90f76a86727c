  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (minLength && value.length < parseInt(minLength, 10)) {
        showError(field, field.dataset.errorMinlength || 'Minimum ' + minLength + ' characters required.');
        return false;
      }

      if (maxLength && value.length > parseInt(maxLength, 10)) {
        showError(field, field.dataset.errorMaxlength || 'Maximum ' + maxLength + ' characters allowed.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '43ad80fa-2ee8-4fc2-95cf-90f76a86727c',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '43ad80fa-2ee8-4fc2-95cf-90f76a86727c';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '43ad80fa-2ee8-4fc2-95cf-90f76a86727c';
